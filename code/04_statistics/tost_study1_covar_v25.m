...
PP    = '/Users/hedylamarr/Documents/MATLAB/thesis_scripts/output72_v25/nmark72v25_postprocess_results';
...
for i=1:nSub
    s=load(fullfile(PP,sprintf('nmark72v25_post_process_sub_%03d.mat',i)));
...
for k=1:2
    ...
    fprintf('============ %s (ADJUSTED, v25 SENSITIVITY) ============\n',labels{k});
...
fprintf('FD από fMRIPrep 21.0.2 (παλιό derivative)· τα FNC εδώ από v25 (25.x). Το FD είναι χαρακτηριστικό του ατόμου, αλλά η αναντιστοιχία δηλώνεται.\n');
