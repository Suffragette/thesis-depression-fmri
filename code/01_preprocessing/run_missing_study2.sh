#!/bin/bash
# Study 2: ONLY the missing subjects (13,14,15,21-29)
set -u
...
for n in 13 14 15 21 22 23 24 25 26 27 28 29; do
  sub="sub-$n"
...
echo "=== ΤΕΛΟΣ (12 άτομα που έλειπαν) ==="
ls "$OUT"/*_clean_smooth.nii.gz 2>/dev/null | wc -l
echo "νέα clean αρχεία (στόχος: 24 = 12 άτομα × 2)"
